...
const Button = forwardRef(({
  ...
  const variants = {
    ...
    outline: 'text-primary-600 bg-transparent border border-primary-600 hover:bg-primary-50 focus:ring-primary-500',
    danger: 'text-white bg-red-600 hover:bg-red-700 focus:ring-red-500',
    ghost: 'text-gray-600 bg-transparent hover:bg-gray-100 focus:ring-primary-500',
  };
